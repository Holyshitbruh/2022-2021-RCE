...
def title():
    ...
    print('''
    +===========================================================================+
        Validation mode：python CVE_2021_22986.py -v true -u target_url 
        Attack mode：python CVE_2021_22986.py -a true -u target_url -c command 
        Batch detection：python CVE_2021_22986.py -s true -f file
        Bounce mode：python CVE_2021_22986.py -r true -u target_url -c command 
    +===========================================================================+
        ''')
